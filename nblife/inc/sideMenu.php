                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <a href="#"><i class="fa fa-files-o fa-fw"></i>Customer Pages<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                <a href="<?php echo $GLOBALS['BASE_URL'] .'pages/resources'; ?>">Resources</a>
                                </li>
                                <li>
                                    <a href="<?php echo $GLOBALS['BASE_URL'] .'pages/secretsauce'; ?>">Secret Sauce</a>
                                </li>
                                <li>
                                    <a href="<?php echo $GLOBALS['BASE_URL'] .'pages/lifestyleataglance'; ?>">Lifestyle At A Glance</a>
                                </li>
                                <li>
